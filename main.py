...
# Crear variable en session_state para controlar el acceso
...
if not st.session_state.authenticated:
    st.text_input("Ingrese la contraseña:", type="password", key="password_input", on_change=check_password)
    st.stop()  # Detiene la ejecución para que no se muestre lo siguiente hasta validar
else:
# ─────────────────────────────────────────────────────────────────────────────
